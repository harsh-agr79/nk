...
@section('main')
    ...
    <div class="container">
        ...
        <span class="center-align"><h4>Payments List</h4></span>
            ...
            <div class="modal-content">
              ...
              <form id="addform" class="row">
                  ...
                  <div class="col s12 m6">
                    <input type="date" name="date" value="{{date('Y-m-d')}}" placeholder="Date" required>
                  </div>
                  ...
                  <div class="col s12 row" id="oidselect">
    ...
    <div class="deletemodal">
        <div id="deletepaymodal" class="modal">
            <div class="modal-content">
              <h4>Are you sure you want to delete <span id="paymentid"></span> from Payments?</h4>
    ...
    <script src="{{asset('assets/ajax/payment.js')}}"></script>
@endsection